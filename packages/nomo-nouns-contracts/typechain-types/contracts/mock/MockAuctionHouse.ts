...
export interface MockAuctionHouseInterface extends utils.Interface {
  functions: {
...
export interface MockAuctionHouse extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockAuctionHouseInterface;
