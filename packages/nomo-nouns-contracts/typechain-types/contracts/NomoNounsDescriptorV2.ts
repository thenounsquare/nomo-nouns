...
export interface NomoNounsDescriptorV2Interface extends utils.Interface {
  functions: {
    ...
    "getNomoSerialNumber(uint256,uint256)": FunctionFragment;
    ...
    "nomoToNounMapper()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNomoSerialNumber",
  ...
  encodeFunctionData(
    functionFragment: "nomoToNounMapper",
    values?: undefined
  ): string;
...
export interface NomoNounsDescriptorV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NomoNounsDescriptorV2Interface;
  ...
  functions: {
    ...
    getNomoSerialNumber(
      tokenId: PromiseOrValue<BigNumberish>,
      tokenNounId: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    nomoToNounMapper(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    nomoToNounMapper(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nomoToNounMapper(overrides?: CallOverrides): Promise<PopulatedTransaction>;
