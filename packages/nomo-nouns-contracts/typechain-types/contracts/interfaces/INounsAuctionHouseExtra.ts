...
export declare namespace INounsAuctionHouse {
...
export interface INounsAuctionHouseExtraInterface extends utils.Interface {
  functions: {
...
export interface INounsAuctionHouseExtra extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INounsAuctionHouseExtraInterface;
  ...
  functions: {
    ...
    ): Promise<[INounsAuctionHouse.AuctionStructOutput]>;
