...
export interface AuctionHouseInterface extends utils.Interface {
    functions: {
        ...
        "createAuction(uint256,uint256,uint256,bool)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "auction" | "createAuction"): FunctionFragment;
...
export interface AuctionHouse extends BaseContract {
    ...
    functions: {
        ...
        createAuction(nounId: PromiseOrValue<BigNumberish>, startTime: PromiseOrValue<BigNumberish>, endTime: PromiseOrValue<BigNumberish>, settled: PromiseOrValue<boolean>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        createAuction(nounId: PromiseOrValue<BigNumberish>, startTime: PromiseOrValue<BigNumberish>, endTime: PromiseOrValue<BigNumberish>, settled: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
