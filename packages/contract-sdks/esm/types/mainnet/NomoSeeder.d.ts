...
export interface NomoSeeder extends BaseContract {
    ...
    functions: {
        generateSeed(nounId: PromiseOrValue<BigNumberish>, blockNumber: PromiseOrValue<BigNumberish>, descriptor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[INomoNounsSeeder.SeedStructOutput]>;
    };
    generateSeed(nounId: PromiseOrValue<BigNumberish>, blockNumber: PromiseOrValue<BigNumberish>, descriptor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<INomoNounsSeeder.SeedStructOutput>;
    callStatic: {
        generateSeed(nounId: PromiseOrValue<BigNumberish>, blockNumber: PromiseOrValue<BigNumberish>, descriptor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<INomoNounsSeeder.SeedStructOutput>;
    ...
    filters: {};
    estimateGas: {
        generateSeed(nounId: PromiseOrValue<BigNumberish>, blockNumber: PromiseOrValue<BigNumberish>, descriptor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        generateSeed(nounId: PromiseOrValue<BigNumberish>, blockNumber: PromiseOrValue<BigNumberish>, descriptor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
